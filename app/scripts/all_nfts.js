...
gridCustomList.forEach((item) => {
  item.addEventListener("click", function (e) {
    ...
    gridCustomList.forEach((item) =>
      item.classList.remove("filter-listcustom--active")
    );
    if (e.target.id === style3) {
      styleListChange(
        e.target,
        "./images/icons/grid-2-active.png",
        "filter-listcustom--active",
        gridCustomList[1],
    ...
    if (e.target.id === style4) {
      styleListChange(
        e.target,
        "./images/icons/grid-active.png",
        "filter-listcustom--active",
        gridCustomList[0],
        "./images/icons/grid-2.png",
        "calc((100% / 4) - 18px)",
        "calc((100% / 3) - 16px)"
      );
    }
...
const tabProperty1 = document.querySelector(
    "#property_1 :where(.tab-property--top)"
  ),
  tabPropertyContent1 = document.querySelector(
    "#property_1 :where(.tab-property--content)"
  ),
  tabProperty2 = document.querySelector(
    "#property_2 :where(.tab-property--top)"
  ),
  tabPropertyContent2 = document.querySelector(
    "#property_2 :where(.tab-property--content)"
  ),
  tabProperty3 = document.querySelector(
    "#property_3 :where(.tab-property--top)"
  ),
  tabPropertyContent3 = document.querySelector(
    "#property_3 :where(.tab-property--content)"
  ),
  tabProperty4 = document.querySelector(
    "#property_4 :where(.tab-property--top)"
  ),
  tabPropertyContent4 = document.querySelector(
    "#property_4 :where(.tab-property--content)"
  );
